<?php
/*
Single Post Template: Single Service Post Template
*/
get_header();
$id 					= get_the_id();
...
if($page_banner === false) { $page_banner = get_field('page_banner',get_page_by_path('services')); }
?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 text-center">
            ...
            <?php endif;?>
						<h5><a class="more" href="<?php echo get_permalink( get_page_by_path( 'services' ) ) ?>"><i class="fa fa-chevron-circle-left"></i> Back to Services index page</a></h5>
          </div>
